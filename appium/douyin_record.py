...
class DouYin(object):
    ...
    def unlock_windows(self):
        ...
        # cur_elem = self.driver.switch_to.active_element
        # self.driver.flick(cur_elem, 3, start_x, end_y)
    ...
    def swipe_video(self, count=30, per_sec=5):
        '''
        滑动douYin视频
        '''
        ...
        try:
            ...
            end_y1 = height
            start_x = width//2
            self.driver.swipe(start_x, start_y, start_x, end_y)  # 第一次提示滑动从上向下滑动
            for i in range(count):  # 循环滑动次数
                self.driver.swipe(start_x, start_y1, start_x, end_y1)  # 循环 从下向上滑动 产生请求视频链接接口调用
                sleep(per_sec)
        except:
            pass
    ...
    def pass_windows(self):
        ...
        # 刷动短视频
        # self.swipe_video(10, 3)
        res = self.driver.stop_recording_screen()
